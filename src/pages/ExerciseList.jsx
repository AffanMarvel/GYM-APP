      ...
      <div className="p-5 slide-up max-w-lg mx-auto space-y-6">
        <header className="flex items-center space-x-4 pt-2">
          ...
          <div>
            ...
            <p className="text-[10px] font-bold text-gym-muted uppercase tracking-widest">{currentExercises.length} Exercises</p>
          </div>
        </header>
        ...
        <div className="space-y-4">
          {filtered.length === 0 ? (
            ...
            filtered.map((ex, i) => (
              <div key={i} className="bg-gym-card rounded-2xl border border-white/5 p-3 flex items-center gap-4 active:scale-[0.98] transition-all">
